...
public abstract class NutshellRpc : Enumeration
{
    ...
    private static readonly string[] methods = GetAll<NutshellRpc>().Select(e => e.Name).ToArray();
    ...
    public static readonly NutshellRpc<NutshellEntityStub[], FindRequest>
    ...
    public static readonly NutshellRpc<NutshellActivityType[], FindRequest> FindActivityTypes =
    ...
    public static readonly NutshellRpc<NutshellLeadOutcome[], FindRequest> FindLeadOutcomes =
    ...
    public static readonly NutshellRpc<NutshellEntityStub[], SearchRequest> SearchCompetitors =
    ...
    public static readonly NutshellRpc<dynamic, SearchRequest> SearchContactsAndUsers =
